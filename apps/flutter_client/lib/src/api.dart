...
import 'package:openapi/src/api/buyer_api.dart';
import 'package:openapi/src/api/dashboard_api.dart';
import 'package:openapi/src/api/finance_api.dart';
import 'package:openapi/src/api/products_api.dart';
import 'package:openapi/src/api/profile_api.dart';
import 'package:openapi/src/api/seller_api.dart';

class Openapi {
  static const String basePath = r'https://apps-jawa-backend.vercel.app';
  ...
  /// Get BuyerApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  BuyerApi getBuyerApi() {
    return BuyerApi(dio, serializers);
  }
  ...
  SellerApi getSellerApi() {
    return SellerApi(dio, serializers);
  }
}
