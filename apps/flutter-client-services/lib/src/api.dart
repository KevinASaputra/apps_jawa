...
import 'package:openapi/src/api/seller_products_api.dart';
...
class Openapi {
  ...
  /// Get SellerProductsApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  SellerProductsApi getSellerProductsApi() {
    return SellerProductsApi(dio, serializers);
  }
}
